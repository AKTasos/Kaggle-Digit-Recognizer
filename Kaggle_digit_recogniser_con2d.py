...
class mnist(Dataset) :
    ...
    def __init__(self):
        ...
        self.x = torch.from_numpy(train.loc[:,train.columns != "label"].values).unsqueeze(1).unsqueeze(1)
...
class Network(nn.Module):
    def __init__(self):
        ...
        # Linear function.
        self.conv2d = nn.Conv2d(in_channels=1, out_channels=10, kernel_size=(1,28) )
